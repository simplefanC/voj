...
直接下载[https://github.com/simplefanc/voj/tree/master/voj-vue](https://github.com/simplefanc/voj/tree/master/voj-vue)
...
修改 `docker-compose.yml`，在 `voj-frontend` 模块中的 `volumes` 中添加如下：
