...
> #### 基于（Spring Cloud + Vue）前后端分离，分布式架构的在线测评系统。 [Demo](https://voj.mobi)

[English Document](README.md)

## 简介

VOJ 是基于分布式、前后端分离的高性能在线评测系统。采用现阶段流行技术实现，采用 Docker 容器化部署。
...
+ 多语言支持：`C`, `C++`, `Java`, `Python`, `C#`，`GoLang` 题目可以选择使用的语言
+ Markdown & LaTeX 支持

## 项目地址

+ 后端：[https://github.com/simplefanC/voj-springboot](https://github.com/simplefanC/voj-springboot)
+ 前端：[https://github.com/simplefanC/voj-vue](https://github.com/simplefanC/voj-vue)
+ 部署：[https://github.com/simplefanC/voj-deploy](https://github.com/simplefanC/voj-deploy)
+ 判题沙箱：[https://github.com/criyle/go-judge](https://github.com/criyle/go-judge)

## 文档

文档地址：[https://docs.voj.mobi](https://docs.voj.mobi)
