...
public class Constants {
    ...
    public enum File {
        ...
        USER_AVATAR_FOLDER("/voj/file/avatar"),

        HOME_CAROUSEL_FOLDER("/voj/file/carousel"),

        MARKDOWN_FILE_FOLDER("/voj/file/md"),

        PROBLEM_FILE_FOLDER("/voj/file/problem"),

        CONTEST_TEXT_PRINT_FOLDER("/voj/file/contest_print"),

        IMG_API("/api/public/img/"),

        FILE_API("/api/public/file/"),

        TESTCASE_TMP_FOLDER("/voj/file/zip"),

        TESTCASE_BASE_FOLDER("/voj/testcase"),

        FILE_DOWNLOAD_TMP_FOLDER("/voj/file/zip/download"),

        CONTEST_AC_SUBMISSION_TMP_FOLDER("/voj/file/zip/contest_ac");
