...
@Slf4j(topic = "voj")
public class CFSubmitter implements Submitter {
    ...
    public void submitCode(DedicatedHttpClient client, SubmissionInfo info, RemoteAccount account) {
    ...
    public String getMaxIdByParseHtml(DedicatedHttpClient client, SubmissionInfo info, RemoteAccount account) {
