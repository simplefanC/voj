...
import com.simplefanc.voj.server.dao.training.TrainingEntityService;
import com.simplefanc.voj.server.dao.training.TrainingProblemEntityService;
...
import com.simplefanc.voj.server.validator.TrainingValidator;
...
public class BeforeDispatchInitService {
    ...
    public void initContestSubmission(Long cid, String displayId, UserRolesVo userRolesVo, Judge judge) {
        ...
        if (!root && !contest.getUid().equals(userRolesVo.getUid())) {
            ...
            if (contest.getAuth().equals(ContestEnum.AUTH_PROTECT.getCode())
